...
PHDIGITAL_DATES = (
    "base/cv_base.md; months supplied by the user 2026-08-17 from their LinkedIn "
    "employment record (Feb 2025 - Jun 2026, 1 yr 5 mos)"
)
...
# without rewriting the underlying bullets; they add no claim of their own.
SUMMARY_RESTATEMENT = (
    "Summary restatement of canonical PH.Digital development facts; no new claim. "
    "User request 2026-08-17 to lead with TypeScript/React positioning."
)
...
SALES_FACTS = [
    ...
    _fact("sales.role.field.title", "Historical title: Field Sales Representative (B2B) at Pcom Solutions, Tel Aviv.", "Field Sales Representative (B2B) | Pcom Solutions, Tel Aviv", he="Field Sales Representative (B2B) | Pcom Solutions, תל אביב", tags=["sales", "historical-title", "field-sales"], provenance=HANDOFF, style="heading", dates="2019-03/2020-08"),
    ...
    _fact("sales.role.leader.title", "Historical title: Team Leader / Sales Supervisor (B2B) at Pcom Solutions, Tel Aviv.", "Team Leader / Sales Supervisor (B2B) | Pcom Solutions, Tel Aviv", he="Team Leader / Sales Supervisor (B2B) | Pcom Solutions, תל אביב", tags=["sales", "historical-title", "leadership"], provenance=HANDOFF, style="heading", dates="2020-08/2025-01"),
...
DEVELOPMENT_FACTS = [
    ...
    _fact("development.summary.frontend", "Summary-level frontend positioning: builds user-facing applications with React, Next.js, and TypeScript.", "Full-Stack Developer experienced in React, Next.js, and TypeScript.", he="מפתח Full-Stack עם ניסיון ב-React, ב-Next.js וב-TypeScript.", tags=["development", "summary", "frontend", "nextjs"], provenance=SUMMARY_RESTATEMENT, style="paragraph"),
    _fact("development.summary.backend", "Summary-level backend positioning: production APIs, workflow systems, and PostgreSQL-based applications built with Python/FastAPI.", "Strong backend experience building production APIs, workflow systems, and PostgreSQL-based applications with Python/FastAPI.", he="ניסיון backend חזק בבניית APIs ב-production, מערכות workflow ואפליקציות מבוססות PostgreSQL עם Python/FastAPI.", tags=["development", "summary", "backend", "databases"], provenance=SUMMARY_RESTATEMENT, style="paragraph"),
    _fact("development.summary.delivery", "Summary-level delivery positioning: owns features from architecture and data modeling through frontend implementation, testing, and CI/CD.", "Takes features from architecture and data modeling through frontend implementation, testing, and CI/CD.", he="מוביל פיצ׳רים מארכיטקטורה ומידול נתונים ועד למימוש frontend, בדיקות ו-CI/CD.", tags=["development", "summary", "full-stack", "testing", "devops"], provenance=SUMMARY_RESTATEMENT, style="paragraph"),
    _fact("development.phdigital.role", "Historical title: Full-Stack Developer at PH.Digital, Herzliya.", "Full-Stack Developer | PH.Digital, Herzliya", he="Full-Stack Developer | PH.Digital, הרצליה", tags=["development", "historical-title"], provenance=LEGACY, style="heading", dates="2025-02/2026-06"),
    _fact("development.phdigital.dates", "PH.Digital role dates are February 2025 to June 2026, approximately 1 year and 5 months.", "February 2025 - June 2026", he="פברואר 2025 - יוני 2026", tags=["development", "date"], provenance=PHDIGITAL_DATES, style="date", dates="2025-02/2026-06"),
    _fact("development.phdigital.fullstack", "Built and maintained full-stack applications with React, TypeScript, and Python/FastAPI from PostgreSQL data models and APIs through frontend implementation.", "Built and maintained full-stack applications with React, TypeScript, and Python/FastAPI, owning features from PostgreSQL data modeling and APIs through frontend implementation.", he="פיתוח ותחזוקה של אפליקציות full-stack ב-React, ב-TypeScript וב-Python/FastAPI, כולל אחריות על פיצ'רים ממודלי נתונים ב-PostgreSQL ו-APIs ועד המימוש בצד הלקוח.", tags=["development", "technical", "full-stack"], provenance=LEGACY),
    ...
    _fact("development.skills.frontend", "Frontend skills: React, Next.js, TypeScript, JavaScript, Tailwind CSS.", "Frontend: React, Next.js, TypeScript, JavaScript, Tailwind CSS", he="Frontend: React, Next.js, TypeScript, JavaScript, Tailwind CSS", tags=["development", "skill", "frontend"], provenance=LEGACY, style="item"),
    ...
    _fact("development.project.mm_backend_core.title", "Project name and shape: mm-backend-core is a Node.js/Express CLI.", "mm-backend-core — Node.js / Express CLI", he="mm-backend-core — CLI ב-Node.js / Express", tags=["development", "project", "project-title", "backend", "nodejs"], provenance="Project name as published; verified against https://github.com/matanmalka1/mm-backend-core and npm mm-backend-core@2.0.2.", style="heading"),
    _fact("development.project.mm_backend_core.links", "mm-backend-core is publicly published on npm and public on GitHub; both are verifiable by a reader.", "npmjs.com/package/mm-backend-core | github.com/matanmalka1/mm-backend-core", he="npmjs.com/package/mm-backend-core | github.com/matanmalka1/mm-backend-core", tags=["development", "project", "open-source"], provenance="Both URLs resolved 2026-08-17: npm registry returned mm-backend-core@2.0.2 (MIT, node>=18); GitHub API returned a public JavaScript repository.", style="date"),
