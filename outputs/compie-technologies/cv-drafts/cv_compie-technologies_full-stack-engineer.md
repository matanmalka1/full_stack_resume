...
Full-Stack Developer with front-end depth in React, JavaScript, and TypeScript, and backend experience in Python/FastAPI and Node.js/Express. Built and maintained production web applications end to end: React frontends, REST APIs, PostgreSQL and MySQL data models, and JWT authentication. Comfortable working across the stack, supporting QA through automated testing, and collaborating with project managers, analysts, and end-users in Agile teams.
...
- Wrote unit and integration tests (pytest) as part of the development workflow, supporting QA processes.
