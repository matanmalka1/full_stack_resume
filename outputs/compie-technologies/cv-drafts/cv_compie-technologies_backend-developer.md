...
Hands-on production experience across Python/FastAPI and Node.js/Express, working with both SQL (PostgreSQL, MySQL) and NoSQL (MongoDB) databases. Built and maintained a production business platform end-to-end: database schema, REST APIs, authentication, async background job scheduling, and third-party integrations, containerized with Docker and deployed on AWS EC2. Comfortable owning backend architecture and articulating integration flows in cross-functional Agile teams.
...
- Wrote unit and integration tests (pytest) as part of the development workflow.
...
| Tools & Cloud | Git, GitHub, Docker, AWS EC2, Postman |
