...
Full-Stack Developer with production experience building end-to-end web applications using React, Python/FastAPI, PostgreSQL, and REST APIs. Experienced in owning features from database schema and backend business logic through frontend delivery, authentication, external integrations, and automated workflows. Combines hands-on product development with client-facing and team leadership experience, plus full-stack projects involving GenAI and LLM integrations.
...
- Delivered product features in Agile sprints, collaborating with frontend and product teams through stand-ups, sprint planning, and retrospectives.
...
- Built full-stack projects with GenAI integrations using the OpenAI API and LLM pipelines, applying Clean Code and SOLID principles.
