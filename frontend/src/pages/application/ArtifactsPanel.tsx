...
export const ArtifactsPanel = ({ applicationId }: { applicationId: string }) => {
  ...
  return (
    <Card aria-labelledby="artifacts-heading" className="bg-cv-surface p-4 shadow-surface sm:p-5">
      <SectionHeader
        align="baseline"
        description="הקבצים שנרשמו למועמדות הזו. כל אחד מהם רשומה בלתי משתנה, ואפשר לבדוק את שלמותו ולהוריד אותו בדיוק כפי שנרשם."
        gap="wide-compact"
