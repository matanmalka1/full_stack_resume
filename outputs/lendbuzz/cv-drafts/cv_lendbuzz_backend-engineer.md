...
Backend-oriented Full-Stack Developer with production experience in Python/FastAPI and PostgreSQL, covering API design, relational data modeling, authentication, and backend architecture. Applies unit and integration testing (pytest) as part of the development workflow. Uses AI coding assistants (Claude Code, GitHub Copilot, Cursor, Codex) as part of the daily development workflow, with critical review of AI-generated code before merging; hands-on experience building production LLM integrations (OpenAI API, Anthropic API) adds a practical understanding of AI system behavior and limitations.
...
|----------|-------------|
| Backend | Python (FastAPI, Flask), Node.js (Express), RESTful APIs, pytest (unit & integration testing) |
| Databases & SQL | PostgreSQL, MySQL, MongoDB, SQLAlchemy, SQL |
| AI-Assisted Development | Claude Code, GitHub Copilot, Cursor, Codex |
