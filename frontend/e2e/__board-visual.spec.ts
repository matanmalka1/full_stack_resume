...
const reason = (code: string) => ({
  code,
  message: `יש פער חוסם מול הדרישות`,
  entity_references: {},
...
const items = [
  ...
  },
  {
    ...
    review_reasons: [reason("blocking_gap")],
  },
  {
    ...base,
    id: "app-3",
  ...
  },
  {
    ...
    current_status: "assignment",
    recruitment_status: "assignment",
    preparation_state: "ready",
    latest_ready_revision_id: "rev-4",
  },
  {
    ...base,
    id: "app-5",
...
test("board", async ({ page }) => {
  ...
  await page.route("**/api/v1/applications**", (route) =>
    route.fulfill({ contentType: "application/json", json: listBody }),
  );
  ...
  await page.screenshot({
    path: "/private/tmp/claude-501/-Users-matanmalka-Projects-resume-python/35527bac-d3ea-4e47-b781-525f4f392267/scratchpad/board-desktop.png",
    fullPage: true,
  });
  await page.setViewportSize({ width: 900, height: 1100 });
  await page.screenshot({
    path: "/private/tmp/claude-501/-Users-matanmalka-Projects-resume-python/35527bac-d3ea-4e47-b781-525f4f392267/scratchpad/board-tablet.png",
    fullPage: true,
  });
  await page.setViewportSize({ width: 390, height: 900 });
  await page.screenshot({
    path: "/private/tmp/claude-501/-Users-matanmalka-Projects-resume-python/35527bac-d3ea-4e47-b781-525f4f392267/scratchpad/board-mobile.png",
    fullPage: true,
  });
});
