...
Full-Stack Developer with hands-on production experience in Python/FastAPI, React, and PostgreSQL, combined with a prior background leading client relationships in an enterprise sales environment. Comfortable working across backend architecture, API integrations, and cloud deployment (AWS EC2), while translating technical work into terms relevant to business stakeholders. Curious about emerging technologies and cloud platforms, with hands-on experience integrating third-party REST APIs into production systems.
...
- Grew team revenue 30% YoY through structured process improvements and stakeholder communication.
