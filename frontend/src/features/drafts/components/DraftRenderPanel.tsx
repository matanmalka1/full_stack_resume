...
/* A.4 frame 6's render step, inline in the editor that produced the revision. Explicit
   ...
   overlay with its retry, while reloading an already-approved revision does not create new
   work.
   ...
   already failed with its own retry, would be a second, contradictory account of the same
   moment. */
