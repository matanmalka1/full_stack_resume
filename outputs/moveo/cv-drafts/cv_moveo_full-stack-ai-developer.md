...
Full-Stack Developer with production experience building end-to-end business applications using Python/FastAPI, React, PostgreSQL, and REST APIs. Built full-stack projects with GenAI integrations, OpenAI and Anthropic APIs, LLM pipelines, and prompt engineering. Experienced in database design, authentication, business logic, third-party integrations, and Agile delivery, with additional exposure to Node.js, MongoDB, Docker, and AWS EC2.
