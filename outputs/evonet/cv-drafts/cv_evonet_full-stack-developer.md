...
Full-Stack Developer with hands-on production experience across React, Python/FastAPI, Node.js, and PostgreSQL. Built and maintained a production business platform end to end: database schema, RESTful API design, authentication, and business logic. Writes tested code and uses AI coding tools as part of the development workflow.
...
| Tools & Cloud | pytest, Git, GitHub, Docker, Postman, AWS EC2 |
