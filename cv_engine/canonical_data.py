...
SALES_FACTS = [
    ...
    _fact("sales.summary.new_business", "Verified full-cycle B2B Sales includes prospecting, discovery, quotations, negotiation, closing, and post-Sales follow-through.", "Full-cycle B2B Sales professional covering prospecting, discovery, quotations, negotiation, closing, and post-Sales follow-through.", he="איש מכירות B2B במחזור מכירה מלא, משלב איתור לקוחות, אפיון צרכים, הצעות מחיר, משא ומתן, סגירה וליווי לאחר המכירה.", tags=["sales", "new-business", "full-sales-cycle", "summary"], provenance=HANDOFF, style="paragraph"),
    ...
    _fact("sales.metric.team_size", "Managed a team of approximately 2-3 Sales representatives.", "Managed a team of approximately 2-3 Sales representatives.", he="ניהול צוות של כ-2-3 נציגי מכירות.", tags=["sales", "leadership", "verified-quantitative"], provenance=HANDOFF, replaces="legacy.team_size.3-4"),
