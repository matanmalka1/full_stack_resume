...
Full-Stack Developer with production experience across the entire web stack: React frontends, Node.js and Python backends, and both SQL and NoSQL databases. Built and shipped business platforms end-to-end: from database schema and REST API design to UI and third-party integrations. Strong problem-solving skills developed through real-world feature delivery in Agile teams.
