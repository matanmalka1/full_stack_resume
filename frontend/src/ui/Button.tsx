...
const baseButtonClasses =
  "inline-flex min-h-11 items-center justify-center gap-2 rounded-control px-4 text-support font-medium transition-colors disabled:pointer-events-none disabled:opacity-60";

const variantButtonClasses: Record<ButtonVariant, string> = {
  primary: "bg-cv-accent text-cv-on-accent hover:bg-cv-accent-hover",
  secondary: "border border-cv-border bg-cv-surface text-cv-text hover:bg-cv-surface-muted",
  ghost: "text-cv-accent hover:bg-cv-accent-soft",
  destructive: "bg-cv-blocker text-cv-on-accent hover:bg-cv-blocker-hover",
};
