...
export type FactAttachmentProfileTarget = ApiSchemas["FactAttachmentProfileTargetResponse"];
export type FactAttachmentSectionTarget = ApiSchemas["FactAttachmentSectionTargetResponse"];
