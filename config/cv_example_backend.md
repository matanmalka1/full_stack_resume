...
Full-Stack Developer with production experience in Python/FastAPI and PostgreSQL. Built and maintained an internal business platform end to end: database schema, REST APIs, JWT authentication, business logic, and async background job scheduling. Set up CI/CD pipelines covering linting, tests, and migration checks. Comfortable owning the backend while collaborating with frontend and product teams in Agile sprints.
