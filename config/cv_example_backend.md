...
> **Example note:** Backend-focused tone (A). Skills reordered: Databases moved above Frontend. Profile emphasizes CRM architecture and backend ownership. Bullets lead with FastAPI/PostgreSQL keywords matching a backend-heavy JD.
